...
<!-- bootstrap-css -->
<link rel="stylesheet" href="{{asset('public/backend/css/bootstrap.min.css')}}"  type='text/css'>
<!-- //bootstrap-css -->
<!-- Custom CSS -->
...
<div class="w3layouts-main">
	...
	?>
		<form action="{{URL::to('/dashboard-admin')}}" method="post">
			{{ csrf_field() }}
...
<script src="{{('public/backend//scripts.js')}}"></script>
