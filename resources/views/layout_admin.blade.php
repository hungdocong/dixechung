            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="{{asset('public/backend/images/anhtui.jpg')}}">
                        <span class="username">
                            <?php 
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('add-product')}}">Thêm thông tin </a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('all-product')}}">Loại xe</a></li>
                                <li><a href="{{URL::to('all-product')}}">Liệt kê</a></li>
                                <li><a href="{{URL::to('add-product')}}">Thêm thông tin</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-book"></i>
                                <span>THÔNG TIN KHÁCH ĐI CÙNG</span>
                            </a>
                            <ul class="sub">
                                <li><a href="{{URL::to('all-product')}}">Liệt kê</a></li>
                                <li><a href="{{URL::to('add-product')}}">Thêm thông tin </a></li>
